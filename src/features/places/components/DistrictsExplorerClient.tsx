  ...
  return (
    <section className="w-full pt-0 pb-8 md:pt-0 md:pb-16 px-4 md:px-6 overflow-hidden relative border-t border-border-subtle/30">
      ...
      <div className="relative w-full group">
        ...
        <div className="flex overflow-x-auto md:overflow-x-visible hide-scrollbar gap-4 md:gap-6 px-6 md:px-4 pb-8 md:pb-0 scroll-smooth snap-x snap-mandatory md:justify-center">

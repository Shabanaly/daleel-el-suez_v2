...
function SidebarItem({
  ...
  return (
    <CustomLink
      href={href}
      className="group/item flex items-center justify-center group-hover/sidebar:justify-start gap-0 group-hover/sidebar:gap-3 w-full p-2 group-hover/sidebar:p-3 rounded-2xl transition-all duration-300 relative overflow-hidden active:scale-95"
    >
      ...
      {/* Icon Box */}
      <div
        className={`relative z-10 shrink-0 w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-300 border ${
          active
      ...
      {/* Label */}
      <span
        className={`relative z-10 text-sm font-bold tracking-tight transition-all duration-300 whitespace-nowrap opacity-0 w-0 group-hover/sidebar:opacity-100 group-hover/sidebar:w-auto overflow-hidden ${
          active
            ? "text-primary"

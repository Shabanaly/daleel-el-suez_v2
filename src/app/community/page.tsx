...
export async function generateMetadata({
  ...
  const title = q
    ? `نتائج "${q}" - مجتمع السويس`
    : 'مجتمع السويس - شارك، اسأل، وتواصل مع أهل مدينتك';

  const description = q
    ? `استكشف مناقشات ومنشورات أهل السويس حول "${q}". شارك برأيك وتجربتك مع المجتمع.`
    : 'مجتمعك المحلي في السويس. شارك أخبارك، اسأل عن متجربتك، وتواصل مع آلاف المستخدمين في أذكى مجتمع محلي.';

...
import { deletePost } from "@/features/community/actions/posts.server";
...
export default function PostHeaderActions({
  ...
  const handleDelete = async () => {
    showConfirm({
      title: "حذف المنشور؟",
      message:
        "هل أنت متأكد من حذف هذا المنشور؟ لا يمكن التراجع عن هذا الإجراء وسيتم حذف جميع الصور والتعليقات المرتبطة به.",
      confirmLabel: "حذف",
      type: "error",
      onConfirm: async () => {
        setIsDeleting(true);
  ...
  return (
    <div className="relative">
      <button
        ...
        className="p-2 rounded-xl hover:bg-background transition-colors rotate-90 "
      >

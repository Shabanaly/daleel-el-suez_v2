  ...
  useEffect(() => {
    ...
    const initializeOneTap = () => {
      ...
      if (
        ...
        console.warn(
          `[GSI] Detect non-secure origin: ${window.location.origin}. Google One Tap (GSI) will likely fail with "origin_not_allowed". Please use localhost or a secure HTTPS domain.`,
        );
      }

                ...
                >
                    ...
                    <div className="flex gap-3 md:gap-4 items-center">
                        <div className="relative flex-1 group">
                            ...
                            <div className="relative self-stretch flex items-center bg-surface/90 dark:bg-elevated/90 backdrop-blur-2xl border-2 border-border-subtle/60 rounded-2xl md:rounded-3xl shadow-xl shadow-black/5 dark:shadow-primary/10 transition-all duration-300 h-14 md:h-18">
                                <SearchAutocomplete
                                    ...
                                    inputClassName="w-full h-full bg-transparent border-none outline-none text-text-primary flex items-center placeholder-text-muted/60 pr-6 md:pr-10 pl-6 text-base md:text-xl font-bold"
                                />
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            className={`relative h-14 md:h-18 w-14 md:w-18 rounded-2xl md:rounded-3xl border-2 transition-all duration-300 shrink-0 shadow-lg flex items-center justify-center ${showFilters || hasActiveFilters

            ...
            <div className="max-w-5xl mx-auto px-4 relative z-10">
                <div className="grid grid-cols-2 md:grid-cols-6 lg:grid-cols-12 gap-12 md:gap-8 pb-16">
                    ...
                    <div className="col-span-1 md:col-span-1 lg:col-span-2">
                        ...
                        <ul className="space-y-4">
                            ...
                            <li>
                                <Link href="/best" className="text-text-muted text-sm font-bold hover:text-primary transition-colors">
                                    أفضل ما في السويس
                                </Link>
                            </li>
                            <li>
                ...
                <div className="pt-8 border-t border-border-subtle/50 flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <div className="flex items-center gap-6">
                        <Link target="_blank" href="https://www.facebook.com/profile.php?id=61587358715645" className="text-text-muted hover:text-primary transition-all scale-110">

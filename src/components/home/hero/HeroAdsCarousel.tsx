                ...
                {hasMedia ? (
                  activeAd.media_type === "video" ? (
                    <video
                      ...
                      loop
                      playsInline
                      className="absolute inset-0 w-full h-full object-contain transition-transform duration-1200 ease-out group-hover:scale-105"
                    />
                  ) : (
                    <Image
                      src={activeAd.media_url!}
                      ...
                      className="object-contain transition-transform duration-1200 ease-out group-hover:scale-105"
                      priority
                    />
                  )
                ) : (

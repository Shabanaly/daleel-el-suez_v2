export const APP_CONFIG = {
  ...
  GA_ID: "G-CYWJ3TSSFF",
  DESCRIPTION:
    "دليل السويس هو المنصة الأولى لاستكشاف محافظة السويس في مصر. اكتشف أفضل المطاعم، العيادات، المحلات، والخدمات، بالإضافة إلى سوق السويس والوظائف المتاحة يومياً.",
  THEME_COLOR: "#0066FF",
  // Contact Info

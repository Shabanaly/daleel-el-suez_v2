...
interface PlacesFilterModalProps {
    ...
    onApply: (filters: { district: string; area: string; sort: SortOption }) => void;
    onClear: () => void;
}
                            ...
                            <section>
                                ...
                                <div className="flex flex-col gap-2">
                                    {[
                                        ...
                                        { value: 'name', label: 'الاسم (أبجدياً أ-ي)' }
                                    ].map(opt => (
                                        <button
                                            key={opt.value}
                                            onClick={() => setLocalSort(opt.value as SortOption)}

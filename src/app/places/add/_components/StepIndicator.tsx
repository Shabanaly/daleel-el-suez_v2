...
const steps = [
    ...
    { id: 2, label: 'بيانات التواصل' },
    { id: 3, label: 'الصور والوصف' },
];

export function StepIndicator({ currentStep }: StepIndicatorProps) {
    return (
        <div className="mb-10 md:mb-14 relative w-full px-4">
            {/* Container for the progress line - constrained between first and last circle */}
            <div className="absolute top-4 md:top-5 right-[16.66%] left-[16.66%] h-[2px] bg-muted/60 z-0" />
                ...
                {steps.map((step) => {
                    ...
                    return (
                        <div key={step.id} className="flex flex-col items-center flex-1">
                            {/* Circle Wrapper to ensure consistent vertical centering */}

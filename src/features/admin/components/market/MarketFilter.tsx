...
export function MarketFilter({ onFilterChange }: MarketFilterProps) {
    ...
    return (
        <div className="flex flex-col sm:flex-row items-center gap-4">
            <div className="relative flex-1 w-full group">
                ...
                <input
                    type="text"
                    placeholder="البحث في الإعلانات (العنوان، الوصف)..."
            ...
            <button className="flex items-center gap-2 px-5 py-3 bg-secondary/10 border border-secondary/20 rounded-2xl text-secondary hover:bg-secondary/20 active:scale-95 transition-all text-xs font-black uppercase">

...
import { Mail, Lock, LogIn, ArrowLeft, Facebook, User, Eye, EyeOff, Loader2 } from 'lucide-react';
            ...
            <div className="relative z-10 w-full max-w-[480px] animate-in fade-in zoom-in duration-700 ease-out-expo">
                <div className="bg-surface/75 backdrop-blur-2xl p-8 md:p-12 rounded-[40px] border border-white/10 shadow-[0_32px_128px_rgba(0,0,0,0.5)] relative overflow-hidden group">
                    ...
                    <div className="text-right mb-10 relative z-10">
                        <h1 className="text-3xl md:text-4xl font-black text-text-primary mb-3 tracking-tight">إنشاء <span className="text-primary-500">حساب جديد</span></h1>
                        <p className="text-text-muted font-bold text-sm md:text-base leading-relaxed opacity-80">انضم لمجتمع دليل السويس واكتشف مدينتك بشكل مختلف</p>
                    </div>
                    ...
                    <form className="space-y-5 relative z-10" onSubmit={handleSubmit}>
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-black text-text-muted mr-3 mb-1 block uppercase tracking-wider">الاسم بالكامل</label>
                            <div className="relative group/input">
                                ...
                                />
                                <User className="absolute right-5 top-1/2 -translate-y-1/2 w-6 h-6 text-text-muted group-focus-within/input:text-primary-500 transition-colors" />
                            </div>
                        </div>
                        ...
                        {/* Password Field */}
                        <div className="space-y-2">
                            <label className="text-xs font-black text-text-muted mr-3 mb-1 block uppercase tracking-wider">كلمة المرور</label>
                            <div className="relative group/input">
                                <input
                                    name="password"
                    ...
                    <div className="text-center pt-10 relative z-10">
                        <p className="text-sm font-bold text-text-muted">
                            لديك حساب بالفعل؟ <Link href="/login" className="text-primary-500 hover:text-primary-400 underline decoration-2 underline-offset-4 font-black transition-colors">سجل دخولك الآن</Link>
                        </p>
                    </div>
                </div>
            </div>

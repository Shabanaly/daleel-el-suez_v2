    ...
    <footer className="w-full bg-background border-t border-border-subtle pt-20 pb-28 md:pb-12 mt-auto relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-6 lg:grid-cols-12 gap-12 md:gap-8 pb-16">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-5">
            ...
            >
              ...
              <span className="font-black text-2xl text-text-primary tracking-tighter">
                {APP_CONFIG.NAME}
              </span>
            </CustomLink>
            <p className="text-text-muted text-sm md:text-base leading-relaxed max-w-sm font-medium opacity-80">
              اكتشف مدينتك بشكل جديد. مشروع يهدف لتوثيق كل شبر في السويس وتسهيل
              الوصول للخدمات بجودة واحترافية عالية.
            </p>
          </div>
            ...
            <ul className="space-y-4">
              <li className="flex flex-col gap-1">
                ...
                <a href={`mailto:${APP_CONFIG.CONTACT_EMAIL}`}>
                  <span className="text-[10px] text-text-muted font-black uppercase opacity-60 flex items-center gap-2">
        ...
        <div className="pt-8 border-t border-border-subtle/50 flex flex-col md:flex-row items-center justify-between gap-6">
          © {mounted ? new Date().getFullYear() : "2026"} {APP_CONFIG.NAME} •
          لكل أهل السويس 🌊
          <div className="flex items-center gap-6">
            <CustomLink
              target="_blank"
              href={APP_CONFIG.FACEBOOK_URL}
              className="text-text-muted hover:text-primary transition-all scale-110"
            >
            ...
            <CustomLink
              href="#"
              className="text-text-muted hover:text-accent transition-all scale-110"
            >
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">

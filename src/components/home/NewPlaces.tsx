        ...
        <section className="w-full max-w-5xl mx-auto px-4 relative overflow-hidden">
            ...
            <div className="flex items-center justify-between mb-10 relative z-10">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-2xl md:text-4xl font-black text-text-primary tracking-tight">أماكن جديدة</h2>
                        <p className="text-text-muted font-bold text-xs md:text-sm mt-1 opacity-70">اكتشف أحدث الأماكن المضافة لدليل السويس</p>
                    </div>
                </div>
                <Link href="/places?sort=newest" className="group flex items-center gap-2 px-4 py-2 rounded-full border border-border-subtle hover:border-primary/30 hover:bg-primary/5 transition-all duration-300">

...
export default function LeftSidebar() {
    ...
    return (
        ...
        <aside className="hidden lg:flex fixed top-[calc(72px+var(--ticker-height,0px))] left-0 z-40 w-72 h-[calc(100vh-72px-var(--ticker-height,0px))] flex-col bg-surface/50 dark:bg-background/50 backdrop-blur-2xl border-r border-border-subtle shadow-[-20px_0_50px_rgba(0,0,0,0.1)]">

export const APP_CONFIG = {
  ...
  GA_ID: "G-CYWJ3TSSFF",
  DESCRIPTION:
    "اكتشف أفضل الأماكن، الخدمات، والمطاعم في محافظة السويس. دليل السويس هو الرفيق الأول لأهل السويس لاستكشاف مدينتهم والحصول على أفضل العروض والخدمات الموثوقة.",
  THEME_COLOR: "#0066FF",
  // Contact Info
